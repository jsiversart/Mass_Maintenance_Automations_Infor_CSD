...
def main():
    ...
    df_sql = pd.read_csv("prod_whse_matches_rank.csv")
    ...
    input_folder = PATHS["whse_rank_data"]
    prefix = "mmicsw"
    ...
    if not matching_files:
        print("No matching 'mmicsw' file found in Downloads.")
        exit()
    ...
    df_erp = pd.read_csv(erp_file, sep='\t')
    ...
    df_erp.loc[df_erp['key'].isin(df_sql['key']), 'whserank'] = 'E'
